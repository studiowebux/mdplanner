...
features: [analytics, rate, brainstorm, brief, c4_component, capacity_plan, customer, dashboard, dns_domain, eisenhower, github, goal, idea, invoice, lean_canvas, marketing_plan, meeting, milestone, mindmap, moscow, note, payment, person, portfolio, quote, retrospective, sticky_note, swot, task, time_entry, upload, contact]
nav_categories:
  ...
  Planning: [brainstorm, brief, idea, reflection, reflection_template, retrospective]
  Portfolio: [portfolio]
...
last_updated: "2026-05-13T01:13:50.059Z"
---

# MD Planner Demo

A modern project management platform for agile teams. TaskFlow combines task
tracking, time management, and team collaboration into a seamless experience.

## Vision
Become the go-to project management solution for remote-first teams by 2027.