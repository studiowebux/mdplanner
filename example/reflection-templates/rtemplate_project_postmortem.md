---
id: rtemplate_project_postmortem
name: Project Postmortem
description: Structured prompts for closing a project — what worked, what failed, and what to carry forward.
period: monthly
categories: [Project, Engineering, Leadership]
