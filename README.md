...
files in a directory. No database, no vendor lock-in, no SaaS subscription. Just
`.md` files with YAML frontmatter that I can read, edit, and version with git.
MD Planner is that tool.
