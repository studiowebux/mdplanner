...
export class MilestoneSidenavModule {
  ...
  bindEvents() {
    // Close button
    document.getElementById("milestoneSidenavClose")?.addEventListener(
      "click",
      () => {
        this.close();
      },
    ...
    // Cancel button
    document.getElementById("milestoneSidenavCancel")?.addEventListener(
      "click",
      () => {
        this.close();
      },
    ...
    // Delete button
    document.getElementById("milestoneSidenavDelete")?.addEventListener(
      "click",
      () => {
        this.handleDelete();
      },
    ...
    // Form submit
    document.getElementById("milestoneSidenavForm")?.addEventListener(
      "submit",
      async (e) => {
        e.preventDefault();
        await this.save();
    ...
    const inputs = [
      "milestoneSidenavName",
      "milestoneSidenavTarget",
      "milestoneSidenavStatus",
      "milestoneSidenavDescription",
    ];
    inputs.forEach((id) => {
  ...
  openNew() {
    ...
    // Update header
    document.getElementById("milestoneSidenavHeader").textContent =
      "New Milestone";
  ...
  openEdit(milestoneId) {
    ...
    document.getElementById("milestoneSidenavDelete").classList.remove(
      "hidden",
    );
  ...
  fillForm(milestone) {
    ...
    document.getElementById("milestoneSidenavTarget").value =
      milestone.target || "";
    document.getElementById("milestoneSidenavStatus").value =
  ...
  getFormData() {
    return {
      ...
      description:
        document.getElementById("milestoneSidenavDescription").value.trim() ||
        null,
    };
  }
  ...
  async handleDelete() {
    ...
    const milestone = this.tm.milestones.find((m) =>
      m.id === this.editingMilestoneId
    );
    if (!milestone) return;
