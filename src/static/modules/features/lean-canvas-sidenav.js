...
export class LeanCanvasSidenavModule {
  ...
  bindEvents() {
    document.getElementById('leanCanvasSidenavClose')?.addEventListener('click', () => this.close());
    document.getElementById('leanCanvasSidenavCancel')?.addEventListener('click', () => this.close());
    document.getElementById('leanCanvasSidenavDelete')?.addEventListener('click', () => this.handleDelete());

    document.getElementById('leanCanvasSidenavTitle')?.addEventListener('input', () => this.scheduleAutoSave());
    document.getElementById('leanCanvasSidenavDate')?.addEventListener('change', () => this.scheduleAutoSave());

    this.sections.forEach(section => {
      document.getElementById(`leanSidenav_add_${section}`)?.addEventListener('click', () => {
  ...
  openNew() {
    ...
    document.getElementById('leanCanvasSidenavHeader').textContent = 'New Lean Canvas';
    this.fillForm();
  ...
  openEdit(canvasId) {
    ...
    document.getElementById('leanCanvasSidenavHeader').textContent = 'Edit Lean Canvas';
    this.fillForm();
    document.getElementById('leanCanvasSidenavDelete').classList.remove('hidden');
    Sidenav.open('leanCanvasSidenav');
  }
  ...
  fillForm() {
    document.getElementById('leanCanvasSidenavTitle').value = this.currentCanvas.title || '';
    document.getElementById('leanCanvasSidenavDate').value = this.currentCanvas.date || '';
  ...
  async save() {
    this.currentCanvas.title = document.getElementById('leanCanvasSidenavTitle').value.trim();
    this.currentCanvas.date = document.getElementById('leanCanvasSidenavDate').value;
