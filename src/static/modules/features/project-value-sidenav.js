...
export class ProjectValueSidenavModule {
  ...
  bindEvents() {
    document.getElementById('pvbSidenavClose')?.addEventListener('click', () => this.close());
    document.getElementById('pvbSidenavCancel')?.addEventListener('click', () => this.close());
    document.getElementById('pvbSidenavDelete')?.addEventListener('click', () => this.handleDelete());

    document.getElementById('pvbSidenavTitle')?.addEventListener('input', () => this.scheduleAutoSave());
    document.getElementById('pvbSidenavDate')?.addEventListener('change', () => this.scheduleAutoSave());

    this.sections.forEach(section => {
      document.getElementById(`pvbSidenav_add_${section}`)?.addEventListener('click', () => {
  ...
  openNew() {
    ...
    document.getElementById('pvbSidenavHeader').textContent = 'New Project Value Board';
    this.fillForm();
  ...
  openEdit(boardId) {
    ...
    document.getElementById('pvbSidenavHeader').textContent = 'Edit Project Value Board';
    this.fillForm();
  ...
  fillForm() {
    document.getElementById('pvbSidenavTitle').value = this.currentBoard.title || '';
  ...
  async save() {
    this.currentBoard.title = document.getElementById('pvbSidenavTitle').value.trim();
