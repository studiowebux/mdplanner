...
(function () {
  // -----------------------------------------------------------------------
  // Shared dirty-tracking state (referenced by all init functions below)
  // -----------------------------------------------------------------------
  var snapshots = {};
  var dirtyForms = {};
  ...
  // -----------------------------------------------------------------------
  // Dirty tracking: form registration, discard, re-snapshot on save
  // -----------------------------------------------------------------------
  function initDirtyTrackingSetup() {
    ...
    // Expose trackForm so external scripts (e.g. keybindings-settings.js)
    // can register after their async populate step.
  ...
  // -----------------------------------------------------------------------
  // Features: check all / uncheck all + search filter with count
  // -----------------------------------------------------------------------
  function initFeatures() {
    ...
    if (search && featuresForm) {
      ...
      search.addEventListener("input", function () {
        ...
        var items = featuresForm.querySelectorAll(
  ...
  function initLinks() {
    ...
    if (!linksList || !addLinkBtn) return;
  ...
  function initSections() {
    ...
    if (addSectionBtn && sectionNewInput && sectionsList) {
      ...
      addSectionBtn.addEventListener("click", function () {
        ...
        if (!name) return;
        var count = sectionsList.querySelectorAll(
  ...
  // -----------------------------------------------------------------------
  // Navigation: add new category + expand/collapse/jump
  // -----------------------------------------------------------------------
  ...
  function initKpiMetrics() {
    ...
    if (!kpiMetricsList || !addKpiMetricBtn) return;
  ...
  // -----------------------------------------------------------------------
  function initMilestoneStatuses() {
    ...
    if (!milestoneStatusesList || !addMilestoneStatusBtn) return;
