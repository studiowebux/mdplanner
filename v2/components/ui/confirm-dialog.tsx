...
export const ConfirmDialog: FC = () => (
  <dialog class="confirm-dialog" id="confirm-dialog">
    <div class="confirm-dialog__content">
      ...
      <p class="confirm-dialog__message" id="confirm-dialog-message">
        Are you sure?
      </p>
      <div class="confirm-dialog__actions">
        <button class="btn btn--secondary confirm-dialog__cancel" type="button">
          Cancel
        </button>
        <button class="btn btn--danger confirm-dialog__confirm" type="button">
          Confirm
        </button>
      </div>
    </div>
